...
#define SHIP_SHOT_W 15
#define SHIP_SHOT_H 78

#define LIFE_W 50
#define LIFE_H 50

const int ALIEN_W[] = { 81, 119, 115 };
const int ALIEN_H[] = { 85, 87, 150 };
...
#define ALIEN_SHOT_W 26
#define ALIEN_SHOT_H 26
...
ALLEGRO_BITMAP* sprite_all(int x, int y, int w, int h)
{
    ALLEGRO_BITMAP* naves = al_create_sub_bitmap(sprites._allsprites, x, y, w, h);
    must_init(naves, "nave person");
    return naves;
}

void sprites_init()
{
    sprites._sheet = al_load_bitmap("./img/spritesheet.png");
    must_init(sprites._sheet, "spritesheet");

    sprites._allsprites = al_load_bitmap("./img/allsprites.png");
    must_init(sprites._allsprites, "all sprites");



    sprites.ship = sprite_all(426, 0, SHIP_W, SHIP_H);

    sprites.life = sprite_all(526, 0, LIFE_W, LIFE_H);

    sprites.ship_shot[0] = sprite_all(397, 0, SHIP_SHOT_W, SHIP_SHOT_H);
    sprites.ship_shot[1] = sprite_all(411, 0, SHIP_SHOT_W, SHIP_SHOT_H);

    sprites.alien[0] = sprite_all(116, 0, ALIEN_BUG_W, ALIEN_BUG_H);
    sprites.alien[1] = sprite_all(231, 0, ALIEN_ARROW_W, ALIEN_ARROW_H);
    sprites.alien[2] = sprite_all(0, 0, ALIEN_THICCBOI_W, ALIEN_THICCBOI_H);

    sprites.alien_shot = sprite_all(575, 0, ALIEN_SHOT_W, ALIEN_SHOT_H);
...
void audio_init()
{
    ...
    sample_shot = al_load_sample("./sons/tiro.wav");
    must_init(sample_shot, "shot sample");

    sample_explode[0] = al_load_sample("./sons/explode2.flac");
    must_init(sample_explode[0], "explode[0] sample");
    sample_explode[1] = al_load_sample("./sons/explosao.wav");
...
int main()
{
    ...
    ALLEGRO_AUDIO_STREAM* music = al_load_audio_stream("./sons/explosion-simulation.opus", 2, 2048);
